    ...
    <>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#F5A623]">Our Core Services</p>
            <h2 className="mt-3 text-3xl font-extrabold tracking-tight text-[#0A1628] sm:text-4xl">
      ...
      <section className="relative overflow-hidden bg-slate-50 py-20">
        <div className="absolute -left-24 top-10 h-48 w-48 rounded-full bg-[#F5A623]/20 blur-3xl" />
        <div className="absolute -right-20 bottom-8 h-56 w-56 rounded-full bg-[#0A1628]/10 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            {trustPoints.map((point, index) => (
              ...
              >
                <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-[#0A1628] text-[#F5A623]">
                  <point.icon size={20} />
                </div>
                <h3 className="mt-4 text-xl font-bold text-[#0A1628]">{point.title}</h3>
